...
public class ShooterState {
     ...
     * @param vtop the power of the top shooter wheels in Rotations per Second
     ...
     */
    public ShooterState(double vtop, double vprimer, double pivot_power) {
        this.vt_rotations_per_second = vtop;
        this.vb_rotations_per_second = vtop;
